...
<div class=" m-4">
    <ul class="nav nav-tabs justify-content-center" id="myTab">
        <li class="nav-item">
            <a href="#standard" class="nav-link active" data-bs-toggle="tab">Standard</a>
        </li>
        <li class="nav-item">
            <a href="#withlogo" class="nav-link" data-bs-toggle="tab">With Logo</a>
        </li>
    </ul>
    <div class="tab-content">
                    ...
                    <div class="col-lg-12">
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                ...
                                <form action="/create_s" method="post">
                                @csrf
                                <div class="mx-2 mt-2">
        ...
        <div class="tab-pane fade" id="withlogo">
            <div class="row mt-1">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 mt-4">
                                ...
                                <img src="data:image/png;base64,{{ base64_encode(QrCode::size(300)->format('png')->merge('../storage/app/qrcode/'.$logo ,.3, true)->generate($url) ) }}">
                                </div>
                                <div class="row justify-content-center" >
                                    <div class="btn-group" style="width: 17rem;">
                                    <a href="/downloadpng/{{ $name }}" class="btn btn-primary {{ ($url === "http://aerotech.com/") ? 'disabled' : '' }}">.PNG</a>
